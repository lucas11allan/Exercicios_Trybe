...
import actionSaveForm from './redux/action';
...
class Form1 extends React.Component {
  ...
  montarFormulario = () => {
    this.props.actionSaveForm(this.state);
  }
    ...
    return (
      <div>
        <form>
          ...
          <button type="button" onClick={this.montarFormulario}>Montar o Formulário</button>
...
const mapDispatchToProps = (dispatch) => ({
  actionSaveForm: dadosForm => dispatch(actionSaveForm(dadosForm)),
});
